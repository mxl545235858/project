...
<html>
  ...
  <br/>
    ...
    <form action="login" >
		<input style="height: 35px;width: 270px;border: 1px solid silver;border-radius:5px;
    font-size: 14px;position: relative;left: 3%" name="account" type="text" value="" placeholder="请输入您的账号" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/><br/>
		<input style="height: 35px;width: 270px;border-radius:5px;border: 1px solid silver;
    font-size: 14px;position: relative;left: 3%" name="password" type="text" value="" placeholder="密码" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')" /><br/>
    <br/><br/>
        <input class="denglu1 denglu" type="submit" value="登录"></input>
<br/><br/>
</form>
